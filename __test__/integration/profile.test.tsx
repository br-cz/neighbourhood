...
describe('Searching Integration Tests', () => {
  test('Searching for an event updates the event feed', async () => {
    renderComponent();
  ...
  test('Search for an invalid event does not show any event in the event feed', async () => {
    renderComponent();
