...
export const fetchAllFriendRequestsAPI = async () => {
  ...
  try {
    ...
    throw new HttpError(
      `Error listing all friend requests: ${error.message}`,
      error.statusCode || 500
    );
  }
};

export const createFriendRequestAPI = async (
...
export const getFriendsAPI = async (userId: string) => {
  ...
  try {
    ...
    return friendsJSON.data.getUser.friends ? friendsJSON.data.getUser.friends : [];
  } catch (error: any) {
