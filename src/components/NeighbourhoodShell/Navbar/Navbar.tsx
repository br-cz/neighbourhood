...
import { NavbarProfileButton } from '@/src/components/NeighbourhoodShell/Navbar/NavbarProfileButton/NavbarProfileButton';
import { NavbarCommunityButton } from '@/src/components/NeighbourhoodShell/Navbar/NavbarCommunityButton/NavbarCommunityButton';
import classes from '@/src/components/NeighbourhoodShell/Navbar/Navbar.module.css';
